...
class Creature implements Iterable<Integer> {
    ...
    public int getAgilitiy() {
        return stats[1];
    }

    public void setAgilitiy(int value) {
        stats[1] = value;
    }
...
public class ArrayBackedProperties {
    public static void main(String[] args) {
        ...
        creature.setAgilitiy(12);
        creature.setInteligence(13);
        creature.setStrength(17);

        System.out.println("Creature has a max stat of " + creature.max() +
                ", total stats = " + creature.sum() + ", average stat = " + creature.average());
    }
}
